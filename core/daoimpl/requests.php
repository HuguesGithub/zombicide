...
[LiveMission]
select="SELECT id, liveId, missionId, activeLiveSurvivorId "
from="FROM wp_11_zombicide_live_mission "
where="WHERE liveId LIKE '%s' AND missionId LIKE '%s' "
insert="INSERT INTO wp_11_zombicide_live_mission (liveId, missionId, activeLiveSurvivorId) VALUES ('%s', '%s', '%s');"
update="UPDATE wp_11_zombicide_live_mission SET liveId='%s', missionId='%s', activeLiveSurvivorId='%s' "
[LiveMissionToken]
...
[LiveSurvivor]
select="SELECT id, liveId, survivorId, missionZoneId, survivorTypeId, experiencePoints, hitPoints, playedThisTurn "
