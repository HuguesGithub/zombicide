 ...
 * @since 1.0.00
 */
class LocalDomain extends GlobalDomain {
        ...
        if ( !empty($services) ) {
            foreach ( $services as $service ) {
                switch ( $service ) {
                    ...
                    case 'EquipmentKeyword'         : $this->EquipmentKeywordServices = FactoryServices::getEquipmentKeywordServices(); break;
                    ...
                    case 'Keyword'         : $this->KeywordServices = FactoryServices::getKeywordServices(); break;
                    ...
                    case 'LiveMission'                    : $this->LiveMissionServices = FactoryServices::getLiveMissionServices(); break;
                    case 'LiveToken'                : $this->LiveTokenServices = FactoryServices::getLiveTokenServices(); break;
                    ...
                    case 'SurvivorSkill'            : $this->SurvivorSkillServices = FactoryServices::getSurvivorSkillServices(); break;
