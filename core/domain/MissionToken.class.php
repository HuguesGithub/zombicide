...
/**
   ...
   * @return array
   */
  public function getClassVars() { return get_class_vars('MissionToken'); }
  /**
   * @param array $row
   * @param string $a
   * @param string $b
   * @return MissionToken
   */
  public static function convertElement($row, $a='', $b='') { return parent::convertElement(new MissionToken(), self::getClassVars(), $row); }
