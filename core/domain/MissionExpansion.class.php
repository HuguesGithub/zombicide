...
class MissionExpansion extends LocalDomain {
   ...
   * @return array
   */
  public function getClassVars() { return get_class_vars('MissionExpansion'); }
  /**
   * @param array $row
   * @param string $a
   * @param string $b
   ...
   */
  public static function convertElement($row, $a='', $b='') { return parent::convertElement(new MissionExpansion(), self::getClassVars(), $row); }
  /**
   * @return string
   */
  public function getExpansionCode() { return $this->getExpansion()->getCode(); }
  /**
   * @return string
   */
   ...
   * @return string
   */
  public function getExpansionImageSuffixe() { return $this->getExpansion()->getImageSuffixe(); }
  /**
   * @param Expansion $Expansion
   */
  public function setExpansion($Expansion) { $this->Expansion=$Expansion; }
