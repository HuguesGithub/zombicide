...
class LiveMission extends LocalDomain {
  ...
  public function __construct($attributes=array()) {
    parent::__construct($attributes, array('LiveMission'));
  }
  /**
   * @return int
   */
   ...
   * @return array
   */
  public function getClassVars() { return get_class_vars('LiveMission'); }
  /**
   * @param array $row
   * @param string $a
   * @param string $b
   * @return MissionRule
   */
  public static function convertElement($row, $a='', $b='') { return parent::convertElement(new LiveMission(), self::getClassVars(), $row); }
