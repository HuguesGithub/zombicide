...
[LiveSurvivor]
select="SELECT id, liveId, survivorId, missionZoneId, survivorTypeId, experiencePoints, hitPoints, playedThisTurn, turnRank "
...
insert="INSERT INTO wp_11_zombicide_live_survivor (liveId, survivorId, missionZoneId, survivorTypeId, experiencePoints, hitPoints, playedThisTurn, turnRank) VALUES ('%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s');"
update="UPDATE wp_11_zombicide_live_survivor SET liveId='%s', survivorId='%s', missionZoneId='%s', survivorTypeId='%s', experiencePoints='%s', hitPoints='%s', playedThisTurn='%s', turnRank='%s' "
[LiveSurvivorAction]
