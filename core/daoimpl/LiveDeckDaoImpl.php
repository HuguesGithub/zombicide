...
class LiveDeckDaoImpl extends LocalDaoImpl {
	 ...
	 */
	protected $fromRequest = "FROM wp_11_zombicide_livedeck ";
	/**
	 ...
	 * @var string $insert
	 */
	protected $insert = "INSERT INTO wp_11_zombicide_livedeck (deckKey, dateUpdate) VALUES ('%s', '%s');";
	/**
	 * Requête de mise à jour en base
	 * @var string $update
	 */
	protected $update = "UPDATE wp_11_zombicide_livedeck SET deckKey='%s', dateUpdate='%s' ";
	 ...
	 * @return array
	 */
	protected function convertToArray($rows) { return $this->globalConvertToArray('LiveDeck', $rows); }
	/**
	 * @param string $file
	 * @param int $line
